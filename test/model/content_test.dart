...
class ContentExample {
  ...
  ContentExample.inline(this.description, this.markdown, this.html,
      InlineContentNode parsed, {this.expectedText, bool isEmojiParagraph = false})
    : expectedNodes = [ParagraphNode(links: null, isEmojiParagraph: isEmojiParagraph, nodes: [parsed])];
  ...
  static final emojiUnicode = ContentExample.inline(
    ...
    const UnicodeEmojiNode(emojiUnicode: '\u{1f44d}'), isEmojiParagraph: true);
  ...
  static final emojiCustom = ContentExample.inline(
    ...
    const ImageEmojiNode(
      src: '/user_avatars/2/emoji/images/204.png', alt: ':flutter:'), isEmojiParagraph: true);
  ...
  static final emojiCustomInvalidUrl = ContentExample.inline(
    ...
    const ImageEmojiNode(
      src: '::not a URL::', alt: ':invalid:'), isEmojiParagraph: true);
